...
gulp.task('copyLibsScriptsToJs', ['copyJqueryToJs'], function () {
  return gulp.src([
    ...
    , 'src/libs/imagesloaded/imagesloaded.pkgd.min.js' // preload images
